...
func NewLocalStorage(config *config.Config) (*LocalStorage, error) {
	return &LocalStorage{PublicHost: config.Storage.PublicHost, BasePath: config.Storage.BasePath}, nil //TODO: do error checking in case the path is invalid, no permissions, etc.
}
